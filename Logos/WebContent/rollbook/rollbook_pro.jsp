...
<%
	...
	RDao dao=new RDao();
	dao.addData(user_no, SatWorshipCount, WedWorship, FriWorship, LastSunWorship, SatClean, SRName, SatWorshipCount2, WedWorship2, FriWorship2, LastSunWorship2, SatClean2, ManCount, WomanCount, total, bible, TSatWorshipCount, TFriWorship, TLastSunWorship, TSatClean, TSunClean, invite, RegularMember, NewMember);
